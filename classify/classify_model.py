...
from steely_util.data.dataset import ClassifierDataset
...
from steely_util.logger import TerminalLogger
...
class Classify(object):
    ...
    def continue_from_latest_checkpoint(self):
        ...
        self.classifier.load_state_dict(torch.load(path + classifier_filename))
